...
<?php include_once "include/header.php"; ?>
 ...
 <div class="container-fluid">
  <div class="row">
	...
	<h1 class="text-center">All Available Scholarships</h1>
	<p class="text-center">Make Your Future Bright</p>
		<div class="row">
		<?php
		...
		$page = $_GET['page'];
			...
			$query_p=mysqli_query($conn, "SELECT * FROM `scholarship` WHERE s_date>=NOW()  LIMIT $page1,6");
			do{
		...
		?>
				...
				<div class="col-sm-4" style="margin-bottom: 20px;">
					<div class="card">
					  <div class="hovereffect">
							...
							<div class="overlay">
								<p>
									<a class="btn btn-default rounded-circle" data-toggle="tooltip" title="Quick View" style="border:2px dotted #fff; font-size:22px;" href="scholarship_details.php?s_id=<?php echo $data_p['s_id']; ?>"><b><i class="far fa-eye fa-2x"></i></b></a>
								</p>
							</div>
						</div>
						<div class="card-body">
				...
				<a class="btn btn-danger" type="button" href="scholarship_details.php?s_id=<?php echo $data_p['s_id'];  ?>"> Details <i class="fas fa-chevron-right"></i></a>
						</div>
					</div>
				</div>
			<?php }} while($data_p); ?>
