...
<div class="container">
	...
	<div class="row">
		...
		<div class="col-md-6">
			...
			<div class="row">
				<div class="col-md-6">
					<a href="apply_scholarship.php?s_id=<?php echo $prodr['s_id'];?> " class="btn btn-primary float-right" style="margin-right: 50px;" >Apply Now</a>
				</div>
				<div class="col-md-6">
					<a type="submit" class="btn btn-outline-primary float-right" href="add_wishlist.php?s_id=<?php echo $prodr['s_id']; ?>" style="font-size:22px; font-weight:300px;">Apply Later</a>
				</div>
...
<div class="container">
	...
	?>
				...
				<div class="col-sm-4">
					<div class="card">
					  <div class="hovereffect">
							...
							<div class="overlay">
								<p>
									<a class="btn btn-default rounded-circle" data-toggle="tooltip" title="Quick View" style="border:2px dotted #fff; font-size:22px;" href="scholarship_details.php?s_id=<?php echo $relr['s_id']; ?>"><b><i class="far fa-eye fa-2x"></i></b></a>
								</p>
							</div>
						</div>
						<div class="card-body">
				...
				<a class="btn btn-danger" type="button" href="scholarship_details.php?s_id=<?php echo $relr['s_id'];  ?>"> Details <i class="fas fa-chevron-right"></i></a>
						</div>
					</div>
				</div>
		<?php } ?>
